...
public class MainActivity extends AppCompatActivity {
    ...
    private void initData() {
        ...
        for (int i = 0; i < 15; i++) {
            if (i % 2 == 0) {
                comment = new Comment(i + "", "张三" + i, "http://d.hiphotos.baidu.com/image/h%3D360/sign=856d60650933874483c5297a610fd937/55e736d12f2eb938e81944c7d0628535e5dd6f8a.jpg", 1, "哈佛大学", "今天真开心，敲了一天代码。", "2015-03-04 23:02:06", null);
            }
            if (i % 2 == 1) {
                comment = new Comment(i + "", "张三" + i, "http://g.hiphotos.baidu.com/image/h%3D360/sign=c7fd97e3bc0e7bec3cda05e71f2cb9fa/960a304e251f95ca2f34115acd177f3e6609521d.jpg", 1, "哈佛大学", "今天真开心，敲了一天代码。", "2015-03-04 23:02:06", "王二狗" + i);
            }
